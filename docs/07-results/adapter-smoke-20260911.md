...
> **현재 기준 안내:** 이번 T01~T28 전체 84회 실행의 비교 결과는 [전체 실행 보고서](matrix-results-20260911.md), 회차별 값은 [84회 개별 기록](matrix-runs-20260911.md)을 확인합니다. 아래는 일부 어댑터의 3회 수명주기와 수정 동작을 확인한 선행 스모크 기록입니다. 아래 성능 수치와 후속 검증 계획은 당시 범위의 기록이며, 현재 전체 실행 결과나 제품 순위로 해석하지 않습니다.
