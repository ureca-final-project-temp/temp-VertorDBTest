...
> **현재 기준 안내:** 이번 T01~T28 전체 84회 실행의 비교 결과는 [전체 실행 보고서](matrix-results-20260911.md), 회차별 값은 [84회 개별 기록](matrix-runs-20260911.md)을 확인합니다. 아래는 측정 결함이 확인된 1차 실행의 보존 기록입니다. 아래 성능 수치·순위·판정은 현재 전체 실행의 결론으로 사용하지 않습니다.
