...
> **현재 기준 안내:** 이번 T01~T28 전체 84회 실행의 비교 결과는 [전체 실행 보고서](matrix-results-20260911.md), 회차별 값은 [84회 개별 기록](matrix-runs-20260911.md)을 확인합니다. 아래 문서는 이전 실행에서 결함을 찾고 수정한 근거를 보존합니다. 아래 수치와 당시의 상태 표현은 현재 실행의 성능 비교나 진행 상태를 나타내지 않습니다.
