...
IVF_PQ의 T17·T18은 세 회차 모두 `nprobe=8`을 선택했고 여섯 실행의 Recall이 모두 0.6011이었다. 실제 호출은 완료됐지만 목표 0.90·0.95와 큰 차이가 났다. 이 수치만으로 IVF_PQ 알고리즘 전반의 한계나 특정 원인을 확정하지 않는다. 이번 차원·데이터·인덱스 설정과 후보 그리드에 대한 관측이다.
